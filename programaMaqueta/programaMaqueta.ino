...
void setup() {
  ...
  for (int a=0; a < 8; a++){
    ...
    ombrejat), 5 (Calefacció), 6 (Goteig), 7 (Difusors) i 8 (Llums).*/
  }
  
  digitalWrite (rele[8], LOW);//S'apaga el relè 9 (Llum indicació)*Funciona al revés*.
...
void loop() {
  ...
  if ((temperatura < 15)&&(estatRele[4]==0)){/*Si la variable temperatura és menor a 15º i 
    ...
    digitalWrite (rele[4], LOW); //Activa el relè 5 (Calefacció).
  ...
  if ((temperatura>20)&&(estatRele[4]==2)){/*Quan la variable temperatura és superior a 20º
    ...
    digitalWrite (rele[4], HIGH);//Apaga el relè 5 (Calefacció).
...
*/
  ...
  if ((lluminositatExterior<5) && (estatRele[7]==0)){ /*Si la variable LLuminositat es
    ...
    digitalWrite (rele[7], LOW); //S'encèn el relè 8 (LLums).
  ...
  if (estatRele[7]==2){ //Si el relè8 està està en memòria de procés automàtic:
    digitalWrite (rele[8], HIGH); //S'encèn el relè 9 (Senyalització).*Funciona al revès*
    delay(1000);               //S'espera 1 segón.
    digitalWrite (rele[8], LOW);//S'apaga el relè 9.*Funciona al revès*
  }//Tancament de l'if.
  ...
  if ((lluminositatExterior>20 ) && (estatRele[7]==2)){ /*Si la variable 
    ...
    digitalWrite (rele[7], HIGH);//S'apaga el relè 8.
    digitalWrite (rele[8], LOW);//S'apaga el relè 9.*Funciona al revès*
  ...
  if ((lluminositatExterior<3) && (humitat<30)&&(estatRele[6]==0)){/*Quan la lluminositat
    ...
    digitalWrite (rele[6], LOW);//S'encèn el relè 7 (Difusors).
  ...
  if (estatRele[6]==2){  
    ...
    digitalWrite (rele[6], HIGH); //S'apaga el relè 7.
  ...
  al mateix temps més petit que la hora de finalització de reg (també en minuts) "fi" i el 
  relè 6 està apagat:*/
    digitalWrite (rele[5], LOW);  //S'encèn el relè 6 (Goteig).
  ...
  if (((hour() * 60 + minute())==fi) && (estatRele[5]==2)){/*Si la hora actual és igual a 
    ...
    digitalWrite (rele[5],HIGH);  //S'apaga el relè 6 (Goteig).
  ...
  while (Serial.available() > 0) {// Si la variable es més gran que zero càrrega el codi. 
    ...
    if ((n1==3)&&(n2==0) && (estatRele[7]==1)){/*Si n1 es igual a 3, n2 es igual a 0 i el
      ...
      digitalWrite (rele[7], HIGH);//S'apaga el relè 8 (Llums).
    ...
    if ((n1==4)&&(n2==1) && (estatRele[5]==0)){/*Si n1 es igual a 4, n2 es igual a 1 i el
      ...
      digitalWrite (rele[5], LOW);//S'encèn el relè 6 (Reg per goteig).
    ...
    if ((n1==4)&&(n2==0) && (estatRele[5]==1)){/*Si n1 es igual a 4, n2 es igual a 0 i el
      ...
      digitalWrite (rele[5], HIGH);//S'apaga el relè 6 (Reg per goteig).
    ...
    if ((n1==5)&&(n2==0) && (estatRele[6]==1)){/*Si n1 es igual a 5, n2 es igual a 0 i el
      ...
      digitalWrite (rele[6], HIGH);//S'apaga el relè 7 (Difusors).
    ...
    if ((n1==6)&&(n2==1) && (estatRele[4]==0)){/*Si n1 es igual a 6, n2 es igual a 1 i el
      ...
      digitalWrite (rele[4], LOW);//S'encèn el relè 5 (Calefacció).
    ...
    if ((n1==6)&&(n2==0) && (estatRele[4]==1)){/*Si n1 es igual a 6, n2 es igual a 0 i el
      ...
      digitalWrite (rele[4], HIGH);//S'apaga el relè 5 (Calefacció).
    ...
    if ((n1==7)&&(n2==0)){//Si n1 es igual a 7, n2 es igual a 0:
      digitalWrite (rele[3], HIGH);//S'apaga el relè 4 (Ombrejat).
    ...
    if ((n1==8)&&(n2==2) && (estatRele[0]==0) && (estatRele[2]==0)){/*Si n1 es igual a 8, n2 
      ...
      digitalWrite (rele[2], LOW);//S'encèn el relè 3 (Finestra).
    ...
    if ((n1==8)&&(n2==0)){//Si n1 es igual a 7, n2 es igual a 0:
      digitalWrite (rele[2], HIGH);//S'apaga el relè 3 (Finestra).
